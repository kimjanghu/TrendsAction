  ...
  <header>
    ...
    <div class="router-area" v-if="$vuetify.breakpoint.lgAndUp">
      <ul class="navbar-list">
        ...
        <li class="navbar-list-item" @click="$router.push({ name: 'PredictDetail', params: { year: 2021, month: 11, week: 1, categoryId: 9} })">Predict</li>
    ...
    <div class="sidebar">
      ...
      <ul style="text-align:center">
        ...
        <li style="cursor:pointer;" @click="$router.push({ name: 'PredictDetail', params: { year: 2021, month: 11, week: 1, categoryId: 9} })">Predict</li>
